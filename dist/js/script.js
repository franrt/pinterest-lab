...
$(document).ready(function() {
    ...
    //slice al json para obtenr la mitad primero y cargar la otra mitad al hacer scroll hasta el final de la pág
    var setOne = pinterest.slice(0, 19);
